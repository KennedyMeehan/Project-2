...
class Gui:
    def __init__(self, window):
        '''This class calculates the areas of various shapes

            The gui window allows the user to select which shape they want the area of
            as well as enter the values needed to to calculation.
            
            Along with this this class creates a display for the shape areas.
    ...
    def shape(self):
        '''This function selects the preferred shape area of the user and displays
            the 
        '''
